...
void  test1() {
    ...
    for (int i : {3,5,7,12,23,12,4,100,0, 3,5,7})
        pq.push(i);//!pushes in decreasing order
    ...
    pq.pop();//! pops the first largest element when it is start
    display(pq);
}
...
void test2() {
    ...
    display(pq);//!displays in the form of the letters in decreasing order as mentioned above.
}
