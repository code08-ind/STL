...
//     if (std::all_of(vec1.begin(), vec1.end(), [](int x) { return x < 20; }))//? square brackets are a capture block.
...
void string_transform_test()
{
    ...
    std::transform(str1.begin(), str1.end(), str1.begin(), ::toupper);//! second str1.begin() is used to tell that from where you want to place the transformed characters
