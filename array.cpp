...
void test6()
{
    ...
    std::array<int, 5> arr1{2, 1, 3, 5, 5}; // double {{ }} is C++ 11

    auto adjacent = std::adjacent_find(arr1.begin(), arr1.end());//? finds out the same elements in the array if adjacebt they exist
...
void test7()
{
    ...
    int sum = std::accumulate(arr1.begin(), arr1.end(), 0);//! finds the sum of the numbers in array
...
void test8()
{
    ...
    int count = std::count(arr1.begin(), arr1.end(), 3);//! counts the 3 if present in the array
